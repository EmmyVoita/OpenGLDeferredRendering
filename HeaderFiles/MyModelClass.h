...
public:
	...
	MyModelClass(Material* material, Texture* overrideTextureDiffuse, Texture* overrideNormal, Texture* overrideDisplacment, Texture* overrideGloss, Texture* overrideRoughness, const char* fileName, glm::mat4 &ViewMatrix, glm::mat4 &ProjectionMatrix)
	{
		this->material = material;
		this->overrideTextureDiffuse = overrideTextureDiffuse;
