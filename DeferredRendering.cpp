...
void renderScreenQuad(Shader2* shader)
{
...
int main()
{
	...
	shaders.push_back(new Shader2("Shaders/renderScreenToQuad.vs", "Shaders/renderScreenToQuad.frag"));
    ...
    materials.push_back(new Material(glm::vec3(0.9f), glm::vec3(2.f), glm::vec3(.6f), 4, 5, 12,13,14,15, 1.0, glm::vec2(1.5f, 1.5f))); 
	materials.push_back(new Material(glm::vec3(0.9f), glm::vec3(1.f), glm::vec3(1.f), 6, 7, 0.8, glm::vec2(1.0f, 1.0f))); 
	materials.push_back(new Material(glm::vec3(1.4f), glm::vec3(2.f), glm::vec3(.6f), 8, 9, 16,17,18,19, 1.0, glm::vec2(4.0f, 4.0f))); 
    ...
    myModels.push_back(new MyModelClass(materials[2], textures[5],textures[6], textures[7],textures[8],textures[9],  "Models/table top.txt", ViewMatrix, ProjectionMatrix));
	myModels.push_back(new MyModelClass(materials[3], textures[2],  "Models/makeupremover2.txt", ViewMatrix, ProjectionMatrix));
	myModels.push_back(new MyModelClass(materials[4], textures[3], textures[10], textures[3],textures[3], textures[3], "Models/GroundPlane2.txt", ViewMatrix, ProjectionMatrix));
	...
	myModels.push_back(new MyModelClass(materials[6], textures[0], "Models/Plush1.txt", ViewMatrix, ProjectionMatrix));
	...
	FillGBuffer* fillGBuffer = new FillGBuffer(myModels);
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		fillGBuffer->PassGTextures(shaders[2]);
		renderScreenQuad(shaders[2]);
